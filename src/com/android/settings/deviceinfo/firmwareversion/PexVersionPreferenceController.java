...
public class PexVersionPreferenceController extends BasePreferenceController {
    ...
    private static final String TAG = "pexVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String PROPERTY_PEX_VERSION = "org.pex.version";
    private static final String PROPERTY_PEX_CODENAME = "ro.pex.build_codename.";
    ...
    public CharSequence getSummary() {
        String pexVersion = SystemProperties.get(PROPERTY_PEX_VERSION,
                mContext.getString(R.string.unknown));
        String pexCodename =  SystemProperties.get(PROPERTY_PEX_CODENAME,
                this.mContext.getString(R.string.unknown));
        if (!pexVersion.isEmpty() && !pexCodename.isEmpty())
            return pexVersion + " | " + pexCodename;
        else
            return mContext.getString(R.string.pex_version_default);
    }
